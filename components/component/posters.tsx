...
export function Posters() {
  return (
    ...
    <div className="grid md:grid-cols-5 gap-9 min-h-96 mb-12 p-6 lg:p-9 mx-auto border  border-stone-300 rounded-3xl relative bg-gradient-to-br from-white/40 to-neutral-100/50">
        ...
        <div className="p-6 md:col-span-3 min-h-96 max-w-2xl">
          ...
          <div className="mt-12 mb-4 w-60 text-center py-1 px-2 rounded-full text-xs bg-amber-200 text-stone-700 opacity-60">HQ, 300 Dpi printable Poster Series</div>
