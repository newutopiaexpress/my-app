...
export default function ChatDark() {
  ...
  return (
    <div className="flex flex-col text-center w-full mx-auto stretch bg-transparent p-9 rounded-3xl">
      <div className="flex space-x-6 mx-auto">
        {predefinedQuestions.map((question, index) => (
          <button
            ...
            className={`w-1/3 p-6 leading-tight bg-transparent text-stone-100 hover:shadow-lg transition-all outline outline-4 outline-offset-2 outline-stone-300/0 hover:outline-4 hover:outline-offset-2 hover:outline-stone-300/50 flex-row justify-center items-center  ${
              question === "Find my superpower!" ? "!bg-stone-900 !text-stone-100 " : ""
            }`}
          >
      ...
      <div className="flex-1 overflow-y-auto mb-4 mt-12 max-h-[490px] w-full mx-auto text-left">
        {messages.map(m => (
      ...
      <form onSubmit={handleSubmit}>
        <input
          className="p-4 w-full mb-16 md:mb-20 border rounded-full transition-all border-gray-300 hover:shadow-xl outline outline-8 outline-offset-4 outline-stone-300/30 hover:outline-offset-0 hover:outline-1 hover:outline-green-200"
          value={input}
