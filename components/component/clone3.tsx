...
export function Clone3() {
  return (
    <div>
      ...
      <div className="grid md:grid-cols-10 min-h-96 mb-12 p-6 lg:p-9 mx-auto shadow-xl rounded-3xl relative bg-gradient-to-br from-stone-100 to-stone-100/50">
