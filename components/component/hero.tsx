...
export function Hero() {
  return (
    <div className="bg-transparent mx-auto w-full mt-10 mb-12">
          ...
          <iframe width="560" height="315" src="https://www.youtube.com/embed/kamKssKuYok?si=fSYkglrNM5brNQDK" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"></iframe>
    </div>
  )
}
