...
export function Hero() {
  return (
    <div className="bg-transparent mx-auto w-full mt-10 mb-12">
          ...
          <iframe className="mx-auto rounded-2xl shadow-2xl" width="560" height="315" src="https://www.youtube.com/embed/1sQCcBb_Kyw?si=DmTsvnctvaHsoueS" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
    </div>
  )
}
