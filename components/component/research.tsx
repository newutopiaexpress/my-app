...
export function Research() {
  return (
    <div className="mt-12 mb-9">
        ...
        <div className="transition-all w-full grid md:grid-cols-2 lg:grid-cols-3 lg:gap-6 border-stone-300 rounded-3xl bg-green-500 shadow-xl hover:shadow-lime-200/80 hover:shadow-lg shadow-lime-700/30">
